                       ...
                       int32_t x, int32_t y, int32_t *v)
{
	x /= (1 << 4);
	y /= (1 << 4);
	if (x < 0 || x > gpu->g3d.viewport_right
	 || y < 0 || y > gpu->g3d.viewport_bottom)
		return;
	int32_t z = v[1];
	int32_t w = v[2];
	int32_t s = v[3];
                          ...
                          struct vertex *v3)
{
	...
	if (v3->screen_y / (1 << 4) == v1->screen_y / (1 << 4)
	 || v3->screen_y / (1 << 4) == v2->screen_y / (1 << 4))
		return;
