...
#undef SWAP_INTERP
	...
	if (maxy > gpu->g3d.viewport_bottom * (1 << 12))
	{
		...
		nnx1 -= fp12_mul(stepnx1, diff);
		nnx2 -= fp12_mul(stepnx2, diff);
		nny1 -= fp12_mul(stepny1, diff);
		nny2 -= fp12_mul(stepny2, diff);
		nnz1 -= fp12_mul(stepnz1, diff);
		nnz2 -= fp12_mul(stepnz2, diff);
